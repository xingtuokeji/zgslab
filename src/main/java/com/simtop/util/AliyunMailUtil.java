...
//        props.put("mail.smtp.port", ALIDM_SMTP_PORT);
        ...
        props.put("mail.password", "zkZK19901010");
...
//        mailSession.setDebug(true);
        ...
        try {
            ...
            InternetAddress from = new InternetAddress("simtop@aldm.simtop.com.cn");
            message.setFrom(from);
            // 设置收件人邮件地址，比如yyy@yyy.com email todo
